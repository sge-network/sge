...
func NewSgeApp(
	...
	app.StrategicreserveKeeper = *strategicreservemodulekeeper.NewKeeper(
		appCodec,
		keys[strategicreservemoduletypes.StoreKey],
		keys[strategicreservemoduletypes.MemStoreKey],
		app.GetSubspace(strategicreservemoduletypes.ModuleName),
	...
	app.DVMKeeper = *dvmmodulekeeper.NewKeeper(
		appCodec,
		keys[dvmmoduletypes.StoreKey],
		keys[dvmmoduletypes.MemStoreKey],
		app.GetSubspace(dvmmoduletypes.ModuleName),
	)
	dvmModule := dvmmodule.NewAppModule(appCodec, app.DVMKeeper, app.AccountKeeper, app.BankKeeper)

	app.SporteventKeeper = *sporteventmodulekeeper.NewKeeper(
		appCodec,
		keys[sporteventmoduletypes.StoreKey],
		keys[sporteventmoduletypes.MemStoreKey],
		app.GetSubspace(sporteventmoduletypes.ModuleName),
		sporteventmodulekeeper.ExpectedKeepers{
			DVMKeeper: app.DVMKeeper,
		},
	)
	sporteventModule := sporteventmodule.NewAppModule(appCodec, app.SporteventKeeper, app.AccountKeeper, app.BankKeeper, app.DVMKeeper)

	strategicreserveModule := strategicreservemodule.NewAppModule(appCodec, app.StrategicreserveKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.BetKeeper = *betmodulekeeper.NewKeeper(
		...
		betmodulekeeper.ExpectedKeepers{
			SporteventKeeper:       app.SporteventKeeper,
			StrategicreserveKeeper: app.StrategicreserveKeeper,
			DVMKeeper:              app.DVMKeeper,
		},
	)
...
func (app *SgeApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *SgeApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *SgeApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
