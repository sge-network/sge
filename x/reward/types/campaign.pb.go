...
type Campaign struct {
	...
	HouseUID string `protobuf:"bytes,3,opt,name=house_uid,proto3" json:"house_uid"`
	// promoter is the address of campaign promoter.
	// Funds for the campaign would be deducted from this account.
	Promoter string `protobuf:"bytes,4,opt,name=promoter,proto3" json:"promoter,omitempty"`
	// start_ts is the start timestamp of a campaign.
	StartTS uint64 `protobuf:"varint,5,opt,name=start_ts,proto3" json:"start_ts"`
	// end_ts is the end timestamp of a campaign.
	EndTS uint64 `protobuf:"varint,6,opt,name=end_ts,proto3" json:"end_ts"`
	// reward_category is the category of reward.
	RewardCategory RewardCategory `protobuf:"varint,7,opt,name=reward_category,json=rewardCategory,proto3,enum=sgenetwork.sge.reward.RewardCategory" json:"reward_category,omitempty"`
	// reward_type is the type of reward.
	RewardType RewardType `protobuf:"varint,8,opt,name=reward_type,json=rewardType,proto3,enum=sgenetwork.sge.reward.RewardType" json:"reward_type,omitempty"`
	// amount_type is the type of reward amount.
	RewardAmountType RewardAmountType `protobuf:"varint,9,opt,name=reward_amount_type,json=rewardAmountType,proto3,enum=sgenetwork.sge.reward.RewardAmountType" json:"reward_amount_type,omitempty"`
	// amount is the amount of reward.
	RewardAmount *RewardAmount `protobuf:"bytes,10,opt,name=reward_amount,json=rewardAmount,proto3" json:"reward_amount,omitempty"`
	// pool is the tracker of pool funds of the campaign.
	Pool Pool `protobuf:"bytes,11,opt,name=pool,proto3" json:"pool"`
...
func (m *Campaign) GetHouseUID() string {
	if m != nil {
		return m.HouseUID
	}
	return ""
...
var fileDescriptor_6d1d1b3139567e36 = []byte{
	...
	,
}
...
func (m *Campaign) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HouseUID) > 0 {
		...
		i = encodeVarintCampaign(dAtA, i, uint64(len(m.HouseUID)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.UID) > 0 {
