...
// source: sge/market/bet_constraints.proto
...
func (*MarketBetConstraints) Descriptor() ([]byte, []int) {
	return fileDescriptor_9c4a2d8a029d00f3, []int{0}
}
...
func init() { proto.RegisterFile("sge/market/bet_constraints.proto", fileDescriptor_9c4a2d8a029d00f3) }

var fileDescriptor_9c4a2d8a029d00f3 = []byte{
	// 248 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *MarketBetConstraints) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		...
		i = encodeVarintBetConstraints(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	{
...
func encodeVarintBetConstraints(dAtA []byte, offset int, v uint64) int {
	offset -= sovBetConstraints(v)
	base := offset
	for v >= 1<<7 {
...
func (m *MarketBetConstraints) Size() (n int) {
	...
	_ = l
	l = m.MinAmount.Size()
	n += 1 + l + sovBetConstraints(uint64(l))
	l = m.BetFee.Size()
	n += 1 + l + sovBetConstraints(uint64(l))
	return n
}

func sovBetConstraints(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozBetConstraints(x uint64) (n int) {
	return sovBetConstraints(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *MarketBetConstraints) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowBetConstraints
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthBetConstraints
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipBetConstraints(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipBetConstraints(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowBetConstraints
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthBetConstraints
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupBetConstraints
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthBetConstraints        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowBetConstraints          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupBetConstraints = fmt.Errorf("proto: unexpected end of group")
)
