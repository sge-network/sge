...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "sgenetwork.sge.dvm.ProposalStats")
}

func init() { proto.RegisterFile("sge/dvm/stats.proto", fileDescriptor_18b1583139df99d6) }
