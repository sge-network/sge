...
func TestProposalMsgs(t *testing.T) {
	...
	require.Equal(t, uint64(2540), msgUpdateParams.Params.MaxWithdrawalCount)
	require.Equal(t, sdkmath.LegacyNewDecWithPrec(456, 2), msgUpdateParams.Params.HouseParticipationFee)
	require.Equal(t, sdkmath.NewInt(300), msgUpdateParams.Params.MinDeposit)
}
