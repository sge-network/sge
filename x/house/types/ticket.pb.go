...
// DepositTicketPayload indicates data of bet deposit ticket.
type DepositTicketPayload struct {
	// kyc_data contains the details of user kyc.
	KycData KycDataPayload `protobuf:"bytes,1,opt,name=kyc_data,json=kycData,proto3" json:"kyc_data"`
}
...
func (m *DepositTicketPayload) GetKycData() KycDataPayload {
	if m != nil {
		return m.KycData
	}
...
// WithdrawTicketPayload indicates data of bet withdrawal ticket.
...
func (m *WithdrawTicketPayload) GetKycData() KycDataPayload {
	if m != nil {
		return m.KycData
	}
	return KycDataPayload{}
...
var fileDescriptor_1f686c28436675f2 = []byte{
	...
	,
}
