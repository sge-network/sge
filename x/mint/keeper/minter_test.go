...
func TestTokenSupply(t *testing.T) {
	...
	require.Equal(t, int64(150010020022000), tokenSupply.Int64())
}
...
func TestBondedRatio(t *testing.T) {
	...
	expectedBondedRatio, _ := sdk.NewDecFromStr("0.000000066662213621")
...
func TestMintCoins(t *testing.T) {
	...
	require.Equal(t, int64(150010020022200), totalSupply.Int64())
}
