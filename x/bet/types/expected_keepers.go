...
type OrderBookKeeper interface {
	ProcessBetPlacement(ctx sdk.Context, uniqueLock, bookID, oddsID string, maxLossMultiplier sdk.Dec, payoutProfit sdk.Int, bettorAddress sdk.AccAddress, betFee sdk.Int, oddsType OddsType, oddsVal string, betID uint64) ([]*BetFulfillment, error)
