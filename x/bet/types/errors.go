...
var (
	...
	ErrActiveOddsUIDsNotValid     = sdkerrors.Register(ModuleName, 2044, "all provided active odds UIDs in ticket should be related to corresponding sport event and should be valid")
	ErrUserKycFailed              = sdkerrors.Register(ModuleName, 2045, "KYC Validation failed the bettor")
	ErrDuplicateActiveOddsUIDs    = sdkerrors.Register(ModuleName, 2046, "duplicate active odds UIDs has been provided")
	ErrNotAllActiveOddsUIDs       = sdkerrors.Register(ModuleName, 2047, "all of the odds of corresponding sport event should be provided as active odds UIDs in ticket for vig calculation")
