...
var (
	ErrInvalidBetUID                        = sdkerrors.Register(ModuleName, 2001, "invalid Bet Uid")
	ErrInVerification                       = sdkerrors.Register(ModuleName, 2002, "bet verification failed")
	...
	ErrInSRBettorLoses                      = sdkerrors.Register(ModuleName, 2005, "internal error in processing better loss in SR")
	ErrInSRBettorWins                       = sdkerrors.Register(ModuleName, 2006, "internal error in processing better win in SR")
	ErrNoMatchingMarket                     = sdkerrors.Register(ModuleName, 2007, "market not found")
	ErrInvalidOddsUID                       = sdkerrors.Register(ModuleName, 2008, "invalid odds UID")
	ErrEmptyOddsValue                       = sdkerrors.Register(ModuleName, 2009, "odds value should not be empty")
	ErrInvalidMarketUID                     = sdkerrors.Register(ModuleName, 2010, "invalid market UID")
	ErrInvalidTicket                        = sdkerrors.Register(ModuleName, 2011, "invalid ticket")
	ErrInvalidAmount                        = sdkerrors.Register(ModuleName, 2012, "invalid amount")
	ErrNoMatchingBet                        = sdkerrors.Register(ModuleName, 2013, "bet not found")
	ErrResultNotDeclared                    = sdkerrors.Register(ModuleName, 2014, "market result is not declared")
	...
	ErrEndTSIsPassed                        = sdkerrors.Register(ModuleName, 2017, "market is expired")
	ErrOddsUIDNotExist                      = sdkerrors.Register(ModuleName, 2018, "market does not have this odds UID")
	ErrInSRRefund                           = sdkerrors.Register(ModuleName, 2019, "internal error in refunding user in SR")
	ErrInactiveMarket                       = sdkerrors.Register(ModuleName, 2020, "market is not active")
