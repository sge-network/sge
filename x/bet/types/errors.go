...
var (
	...
	ErrInvalidMarketUID                     = sdkerrors.Register(ModuleName, 2010, "valid market UID should be provided")
	...
	ErrEndTSIsPassed                        = sdkerrors.Register(ModuleName, 2017, "the market is expired")
	...
	ErrInactiveMarket                       = sdkerrors.Register(ModuleName, 2020, "the market is not active")
