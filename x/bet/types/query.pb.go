...
type QueryBetsRequest struct {
	Status     Bet_OverallStatus  `protobuf:"varint,1,opt,name=status,proto3,enum=sgenetwork.sge.bet.Bet_OverallStatus" json:"status,omitempty"`
...
func (m *QueryBetsRequest) GetStatus() Bet_OverallStatus {
	if m != nil {
		return m.Status
	}
	return Bet_OVERALL_STATUS_UNSPECIFIED
}
...
var fileDescriptor_9b93ca36013f0806 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= Bet_OverallStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
