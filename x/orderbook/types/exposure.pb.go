...
// source: sge/orderboook/exposure.proto
...
func init() {
	proto.RegisterType((*OrderBookOddsExposure)(nil), "sgenetwork.sge.orderboook.OrderBookOddsExposure")
	proto.RegisterType((*ParticipationExposure)(nil), "sgenetwork.sge.orderboook.ParticipationExposure")
}

func init() {
	proto.RegisterFile("sge/orderboook/exposure.proto", fileDescriptor_90d2f27f5a9b2729)
}
