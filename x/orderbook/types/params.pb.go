...
// source: sge/orderboook/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "sgenetwork.sge.orderboook.Params")
}

func init() { proto.RegisterFile("sge/orderboook/params.proto", fileDescriptor_de2d95e3cc19d141) }
