...
// source: sge/orderboook/participation.proto
...
func init() {
	proto.RegisterType((*OrderBookParticipation)(nil), "sgenetwork.sge.orderboook.OrderBookParticipation")
	proto.RegisterType((*ParticipationBetPair)(nil), "sgenetwork.sge.orderboook.ParticipationBetPair")
}

func init() {
	proto.RegisterFile("sge/orderboook/participation.proto", fileDescriptor_ef2b931ff7c6f37b)
}
