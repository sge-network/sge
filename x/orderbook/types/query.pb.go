...
type QueryBookExposuresResponse struct {
	BookExposures []BookOddExposure `protobuf:"bytes,1,rep,name=book_exposures,json=bookExposures,proto3" json:"book_exposures"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (m *QueryBookExposuresResponse) GetBookExposures() []BookOddExposure {
	if m != nil {
...
type QueryBookExposureRequest struct {
	...
	OddId string `protobuf:"bytes,2,opt,name=odd_id,json=oddId,proto3" json:"odd_id,omitempty"`
}
...
func (m *QueryBookExposureRequest) GetOddId() string {
	if m != nil {
		return m.OddId
	}
	return ""
...
type QueryBookExposureResponse struct {
	...
	BookExposure BookOddExposure `protobuf:"bytes,1,opt,name=book_exposure,json=bookExposure,proto3" json:"book_exposure"`
}
...
func (m *QueryBookExposureResponse) GetBookExposure() BookOddExposure {
	if m != nil {
...
var fileDescriptor_8b016841afa49a45 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// ParticipantFullfilledBets queries fullfilled bets for given orderbook participant.
...
func (m *QueryBookExposureRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OddId) > 0 {
		i -= len(m.OddId)
		copy(dAtA[i:], m.OddId)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.OddId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.BookId) > 0 {
