...
// source: sge/orderboook/orderbook.proto
...
type OrderBook struct {
	...
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=sgenetwork.sge.orderboook.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("sgenetwork.sge.orderboook.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "sgenetwork.sge.orderboook.OrderBook")
}

func init() {
	proto.RegisterFile("sge/orderboook/orderbook.proto", fileDescriptor_fd759bf8b8b48f1e)
}
