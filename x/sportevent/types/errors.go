...
var (
	...
	ErrCanNotBeAltered           = sdkerrors.Register(ModuleName, 1006, "event cannot be altered after resolution")
	...
	ErrEventIsNotPending         = sdkerrors.Register(ModuleName, 1009, "event cannot be resolved as status is not pending")
