...
func TestDecodeStore(t *testing.T) {
	...
	kvPairs := kv.Pairs{
		Pairs: []kv.Pair{
			...
			{Key: types.ParticipationExposureKeyPrefix, Value: cdc.MustMarshal(&participationExposures)},
			{Key: types.ParticipationExposureByIndexKeyPrefix, Value: cdc.MustMarshal(&participationExposures)},
	...
	tests := []struct {
		...
		{"order_book_participation_exposure", fmt.Sprintf("%v\n%v", participationExposures, participationExposures)},
		{"order_book_participation_exposure_by_index", fmt.Sprintf("%v\n%v", participationExposures, participationExposures)},
		{"historical_order_book_participation_exposure", fmt.Sprintf("%v\n%v", participationExposures, participationExposures)},
