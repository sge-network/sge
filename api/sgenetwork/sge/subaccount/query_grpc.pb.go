...
const (
	Query_Subaccount_FullMethodName = "/sgenetwork.sge.subaccount.Query/Subaccount"
	Query_Params_FullMethodName     = "/sgenetwork.sge.subaccount.Query/Params"
)
...
func (c *queryClient) Subaccount(ctx context.Context, in *QuerySubaccountRequest, opts ...grpc.CallOption) (*QuerySubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Subaccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Subaccount(context.Context, *QuerySubaccountRequest) (*QuerySubaccountResponse, error) {
...
func _Query_Subaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_Subaccount_FullMethodName,
	}
