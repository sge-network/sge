...
func init() {
	file_sgenetwork_sge_market_ticket_proto_init()
	md_MarketAddTicketPayload = File_sgenetwork_sge_market_ticket_proto.Messages().ByName("MarketAddTicketPayload")
...
func (x *MarketAddTicketPayload) slowProtoReflect() protoreflect.Message {
	mi := &file_sgenetwork_sge_market_ticket_proto_msgTypes[0]
...
func (x *fastReflection_MarketAddTicketPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sgenetwork.sge.market.MarketAddTicketPayload.uid":
		return x.Uid != ""
	case "sgenetwork.sge.market.MarketAddTicketPayload.start_ts":
		return x.StartTs != uint64(0)
	case "sgenetwork.sge.market.MarketAddTicketPayload.end_ts":
		return x.EndTs != uint64(0)
	case "sgenetwork.sge.market.MarketAddTicketPayload.odds":
		return len(x.Odds) != 0
	case "sgenetwork.sge.market.MarketAddTicketPayload.status":
		return x.Status != 0
	case "sgenetwork.sge.market.MarketAddTicketPayload.meta":
		return x.Meta != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sgenetwork.sge.market.MarketAddTicketPayload"))
		}
		panic(fmt.Errorf("message sgenetwork.sge.market.MarketAddTicketPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MarketAddTicketPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sgenetwork.sge.market.MarketAddTicketPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MarketAddTicketPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sgenetwork.sge.market.MarketAddTicketPayload.uid":
		panic(fmt.Errorf("field uid of message sgenetwork.sge.market.MarketAddTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketAddTicketPayload.start_ts":
		panic(fmt.Errorf("field start_ts of message sgenetwork.sge.market.MarketAddTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketAddTicketPayload.end_ts":
		panic(fmt.Errorf("field end_ts of message sgenetwork.sge.market.MarketAddTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketAddTicketPayload.status":
		panic(fmt.Errorf("field status of message sgenetwork.sge.market.MarketAddTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketAddTicketPayload.meta":
		panic(fmt.Errorf("field meta of message sgenetwork.sge.market.MarketAddTicketPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sgenetwork.sge.market.MarketAddTicketPayload"))
		}
...
func (x *fastReflection_MarketAddTicketPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sgenetwork.sge.market.MarketAddTicketPayload", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_sgenetwork_sge_market_ticket_proto_init()
	md_MarketUpdateTicketPayload = File_sgenetwork_sge_market_ticket_proto.Messages().ByName("MarketUpdateTicketPayload")
...
func (x *MarketUpdateTicketPayload) slowProtoReflect() protoreflect.Message {
	mi := &file_sgenetwork_sge_market_ticket_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MarketUpdateTicketPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.uid":
		return x.Uid != ""
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.start_ts":
		return x.StartTs != uint64(0)
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.end_ts":
		return x.EndTs != uint64(0)
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.status":
		return x.Status != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sgenetwork.sge.market.MarketUpdateTicketPayload"))
		}
		panic(fmt.Errorf("message sgenetwork.sge.market.MarketUpdateTicketPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MarketUpdateTicketPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sgenetwork.sge.market.MarketUpdateTicketPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MarketUpdateTicketPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.uid":
		panic(fmt.Errorf("field uid of message sgenetwork.sge.market.MarketUpdateTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.start_ts":
		panic(fmt.Errorf("field start_ts of message sgenetwork.sge.market.MarketUpdateTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.end_ts":
		panic(fmt.Errorf("field end_ts of message sgenetwork.sge.market.MarketUpdateTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketUpdateTicketPayload.status":
		panic(fmt.Errorf("field status of message sgenetwork.sge.market.MarketUpdateTicketPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sgenetwork.sge.market.MarketUpdateTicketPayload"))
		}
...
func (x *fastReflection_MarketUpdateTicketPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sgenetwork.sge.market.MarketUpdateTicketPayload", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_sgenetwork_sge_market_ticket_proto_init()
	md_MarketResolutionTicketPayload = File_sgenetwork_sge_market_ticket_proto.Messages().ByName("MarketResolutionTicketPayload")
...
func (x *MarketResolutionTicketPayload) slowProtoReflect() protoreflect.Message {
	mi := &file_sgenetwork_sge_market_ticket_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MarketResolutionTicketPayload) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.uid":
		return x.Uid != ""
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.resolution_ts":
		return x.ResolutionTs != uint64(0)
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.winner_odds_uids":
		return len(x.WinnerOddsUids) != 0
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.status":
		return x.Status != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sgenetwork.sge.market.MarketResolutionTicketPayload"))
		}
		panic(fmt.Errorf("message sgenetwork.sge.market.MarketResolutionTicketPayload does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MarketResolutionTicketPayload) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sgenetwork.sge.market.MarketResolutionTicketPayload does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MarketResolutionTicketPayload) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.winner_odds_uids":
		...
		return protoreflect.ValueOfList(value)
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.uid":
		panic(fmt.Errorf("field uid of message sgenetwork.sge.market.MarketResolutionTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.resolution_ts":
		panic(fmt.Errorf("field resolution_ts of message sgenetwork.sge.market.MarketResolutionTicketPayload is not mutable"))
	case "sgenetwork.sge.market.MarketResolutionTicketPayload.status":
		panic(fmt.Errorf("field status of message sgenetwork.sge.market.MarketResolutionTicketPayload is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sgenetwork.sge.market.MarketResolutionTicketPayload"))
		}
...
func (x *fastReflection_MarketResolutionTicketPayload) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sgenetwork.sge.market.MarketResolutionTicketPayload", d.FullName()))
	}
	panic("unreachable")
}
...
func (*MarketAddTicketPayload) Descriptor() ([]byte, []int) {
	return file_sgenetwork_sge_market_ticket_proto_rawDescGZIP(), []int{0}
}
...
func (*MarketUpdateTicketPayload) Descriptor() ([]byte, []int) {
	return file_sgenetwork_sge_market_ticket_proto_rawDescGZIP(), []int{1}
}
...
func (*MarketResolutionTicketPayload) Descriptor() ([]byte, []int) {
	return file_sgenetwork_sge_market_ticket_proto_rawDescGZIP(), []int{2}
}
...
var File_sgenetwork_sge_market_ticket_proto protoreflect.FileDescriptor

var file_sgenetwork_sge_market_ticket_proto_rawDesc = []byte{
	,
	...
	,
	...
	,
}

var (
	file_sgenetwork_sge_market_ticket_proto_rawDescOnce sync.Once
	file_sgenetwork_sge_market_ticket_proto_rawDescData = file_sgenetwork_sge_market_ticket_proto_rawDesc
)

func file_sgenetwork_sge_market_ticket_proto_rawDescGZIP() []byte {
	file_sgenetwork_sge_market_ticket_proto_rawDescOnce.Do(func() {
		file_sgenetwork_sge_market_ticket_proto_rawDescData = protoimpl.X.CompressGZIP(file_sgenetwork_sge_market_ticket_proto_rawDescData)
	})
	return file_sgenetwork_sge_market_ticket_proto_rawDescData
}

var file_sgenetwork_sge_market_ticket_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_sgenetwork_sge_market_ticket_proto_goTypes = []interface{}{
	(*MarketAddTicketPayload)(nil),        // 0: sgenetwork.sge.market.MarketAddTicketPayload
	(*MarketUpdateTicketPayload)(nil),     // 1: sgenetwork.sge.market.MarketUpdateTicketPayload
	(*MarketResolutionTicketPayload)(nil), // 2: sgenetwork.sge.market.MarketResolutionTicketPayload
	(*Odds)(nil),                          // 3: sgenetwork.sge.market.Odds
	(MarketStatus)(0),                     // 4: sgenetwork.sge.market.MarketStatus
}
var file_sgenetwork_sge_market_ticket_proto_depIdxs = []int32{
	3, // 0: sgenetwork.sge.market.MarketAddTicketPayload.odds:type_name -> sgenetwork.sge.market.Odds
	4, // 1: sgenetwork.sge.market.MarketAddTicketPayload.status:type_name -> sgenetwork.sge.market.MarketStatus
	4, // 2: sgenetwork.sge.market.MarketUpdateTicketPayload.status:type_name -> sgenetwork.sge.market.MarketStatus
	4, // 3: sgenetwork.sge.market.MarketResolutionTicketPayload.status:type_name -> sgenetwork.sge.market.MarketStatus
...
func init() { file_sgenetwork_sge_market_ticket_proto_init() }
func file_sgenetwork_sge_market_ticket_proto_init() {
	if File_sgenetwork_sge_market_ticket_proto != nil {
		return
	}
	file_sgenetwork_sge_market_market_proto_init()
	file_sgenetwork_sge_market_odds_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_sgenetwork_sge_market_ticket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sgenetwork_sge_market_ticket_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sgenetwork_sge_market_ticket_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sgenetwork_sge_market_ticket_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sgenetwork_sge_market_ticket_proto_goTypes,
		DependencyIndexes: file_sgenetwork_sge_market_ticket_proto_depIdxs,
		MessageInfos:      file_sgenetwork_sge_market_ticket_proto_msgTypes,
	}.Build()
	File_sgenetwork_sge_market_ticket_proto = out.File
	file_sgenetwork_sge_market_ticket_proto_rawDesc = nil
	file_sgenetwork_sge_market_ticket_proto_goTypes = nil
	file_sgenetwork_sge_market_ticket_proto_depIdxs = nil
}
