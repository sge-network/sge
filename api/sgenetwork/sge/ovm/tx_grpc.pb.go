...
const (
	Msg_SubmitPubkeysChangeProposal_FullMethodName = "/sgenetwork.sge.ovm.Msg/SubmitPubkeysChangeProposal"
	Msg_VotePubkeysChange_FullMethodName           = "/sgenetwork.sge.ovm.Msg/VotePubkeysChange"
	Msg_UpdateParams_FullMethodName                = "/sgenetwork.sge.ovm.Msg/UpdateParams"
)
...
func (c *msgClient) SubmitPubkeysChangeProposal(ctx context.Context, in *MsgSubmitPubkeysChangeProposalRequest, opts ...grpc.CallOption) (*MsgSubmitPubkeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SubmitPubkeysChangeProposal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) VotePubkeysChange(ctx context.Context, in *MsgVotePubkeysChangeRequest, opts ...grpc.CallOption) (*MsgVotePubkeysChangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_VotePubkeysChange_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
