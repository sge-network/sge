...
func init() {
	...
	md_PublicKeysChangeProposal = File_sge_legacy_ovm_v1beta_proposal_proto.Messages().ByName("PublicKeysChangeProposal")
...
func (x *PublicKeysChangeProposal) slowProtoReflect() protoreflect.Message {
	mi := &file_sge_legacy_ovm_v1beta_proposal_proto_msgTypes[0]
...
func (x *fastReflection_PublicKeysChangeProposal) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.id":
		return x.Id != uint64(0)
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.creator":
		return x.Creator != ""
	...
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.start_ts":
		return x.StartTs != int64(0)
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.result":
		return x.Result != 0
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.result_meta":
		return x.ResultMeta != ""
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.finish_ts":
		return x.FinishTs != int64(0)
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.status":
		return x.Status != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.ovm.v1beta.PublicKeysChangeProposal"))
		}
		panic(fmt.Errorf("message sge.legacy.ovm.v1beta.PublicKeysChangeProposal does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PublicKeysChangeProposal) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sge.legacy.ovm.v1beta.PublicKeysChangeProposal does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PublicKeysChangeProposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.id":
		panic(fmt.Errorf("field id of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.creator":
		panic(fmt.Errorf("field creator of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.start_ts":
		panic(fmt.Errorf("field start_ts of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.result":
		panic(fmt.Errorf("field result of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.result_meta":
		panic(fmt.Errorf("field result_meta of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.finish_ts":
		panic(fmt.Errorf("field finish_ts of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	case "sge.legacy.ovm.v1beta.PublicKeysChangeProposal.status":
		panic(fmt.Errorf("field status of message sge.legacy.ovm.v1beta.PublicKeysChangeProposal is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sge.legacy.ovm.v1beta.PublicKeysChangeProposal"))
		}
...
func (x *fastReflection_PublicKeysChangeProposal) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sge.legacy.ovm.v1beta.PublicKeysChangeProposal", d.FullName()))
	}
	panic("unreachable")
}
...
func (ProposalResult) Descriptor() protoreflect.EnumDescriptor {
	return file_sge_legacy_ovm_v1beta_proposal_proto_enumTypes[0].Descriptor()
}

func (ProposalResult) Type() protoreflect.EnumType {
	return &file_sge_legacy_ovm_v1beta_proposal_proto_enumTypes[0]
}
...
func (ProposalResult) EnumDescriptor() ([]byte, []int) {
	return file_sge_legacy_ovm_v1beta_proposal_proto_rawDescGZIP(), []int{0}
}
...
func (ProposalStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_sge_legacy_ovm_v1beta_proposal_proto_enumTypes[1].Descriptor()
}

func (ProposalStatus) Type() protoreflect.EnumType {
	return &file_sge_legacy_ovm_v1beta_proposal_proto_enumTypes[1]
}
...
func (ProposalStatus) EnumDescriptor() ([]byte, []int) {
	return file_sge_legacy_ovm_v1beta_proposal_proto_rawDescGZIP(), []int{1}
}
...
var File_sge_legacy_ovm_v1beta_proposal_proto protoreflect.FileDescriptor

var file_sge_legacy_ovm_v1beta_proposal_proto_rawDesc = []byte{
	0x0a, 0x24, 0x73, 0x67, 0x65, 0x2f, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2f, 0x6f, 0x76, 0x6d,
	0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x15, 0x73, 0x67, 0x65, 0x2e, 0x6c, 0x65, 0x67, 0x61,
	0x63, 0x79, 0x2e, 0x6f, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x1a, 0x19, 0x63,
	...
	0x31, 0x62, 0x65, 0x74, 0x61, 0x2f, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x20, 0x73, 0x67, 0x65, 0x2f, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2f, 0x6f,
	0x76, 0x6d, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x2f, 0x76, 0x6f, 0x74, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x03, 0x0a, 0x18, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b,
	...
	,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0x8a, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x70, 0x6f,
	...
	0x4f, 0x50, 0x4f, 0x53, 0x41, 0x4c, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x41, 0x50,
	0x50, 0x52, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x01, 0x12, 0x1c, 0x0a, 0x18, 0x50, 0x52, 0x4f, 0x50,
	0x4f, 0x53, 0x41, 0x4c, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x52, 0x45, 0x4a, 0x45,
	0x43, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x1b, 0x0a, 0x17, 0x50, 0x52, 0x4f, 0x50, 0x4f, 0x53,
	0x41, 0x4c, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x45, 0x58, 0x50, 0x49, 0x52, 0x45,
	0x44, 0x10, 0x03, 0x2a, 0x6b, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x53,
	...
	0x10, 0x01, 0x12, 0x1c, 0x0a, 0x18, 0x50, 0x52, 0x4f, 0x50, 0x4f, 0x53, 0x41, 0x4c, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x46, 0x49, 0x4e, 0x49, 0x53, 0x48, 0x45, 0x44, 0x10, 0x02,
	0x42, 0xe1, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x67, 0x65, 0x2e, 0x6c, 0x65, 0x67,
	0x61, 0x63, 0x79, 0x2e, 0x6f, 0x76, 0x6d, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x42, 0x0d,
...
var (
	file_sge_legacy_ovm_v1beta_proposal_proto_rawDescOnce sync.Once
	file_sge_legacy_ovm_v1beta_proposal_proto_rawDescData = file_sge_legacy_ovm_v1beta_proposal_proto_rawDesc
)

func file_sge_legacy_ovm_v1beta_proposal_proto_rawDescGZIP() []byte {
	file_sge_legacy_ovm_v1beta_proposal_proto_rawDescOnce.Do(func() {
		file_sge_legacy_ovm_v1beta_proposal_proto_rawDescData = protoimpl.X.CompressGZIP(file_sge_legacy_ovm_v1beta_proposal_proto_rawDescData)
	})
	return file_sge_legacy_ovm_v1beta_proposal_proto_rawDescData
}

var file_sge_legacy_ovm_v1beta_proposal_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_sge_legacy_ovm_v1beta_proposal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sge_legacy_ovm_v1beta_proposal_proto_goTypes = []interface{}{
	(ProposalResult)(0),                  // 0: sge.legacy.ovm.v1beta.ProposalResult
	(ProposalStatus)(0),                  // 1: sge.legacy.ovm.v1beta.ProposalStatus
	(*PublicKeysChangeProposal)(nil),     // 2: sge.legacy.ovm.v1beta.PublicKeysChangeProposal
	(*PubkeysChangeProposalPayload)(nil), // 3: sge.legacy.ovm.v1beta.PubkeysChangeProposalPayload
	(*Vote)(nil),                         // 4: sge.legacy.ovm.v1beta.Vote
}
var file_sge_legacy_ovm_v1beta_proposal_proto_depIdxs = []int32{
	3, // 0: sge.legacy.ovm.v1beta.PublicKeysChangeProposal.modifications:type_name -> sge.legacy.ovm.v1beta.PubkeysChangeProposalPayload
	4, // 1: sge.legacy.ovm.v1beta.PublicKeysChangeProposal.votes:type_name -> sge.legacy.ovm.v1beta.Vote
	0, // 2: sge.legacy.ovm.v1beta.PublicKeysChangeProposal.result:type_name -> sge.legacy.ovm.v1beta.ProposalResult
	1, // 3: sge.legacy.ovm.v1beta.PublicKeysChangeProposal.status:type_name -> sge.legacy.ovm.v1beta.ProposalStatus
...
func init() { file_sge_legacy_ovm_v1beta_proposal_proto_init() }
func file_sge_legacy_ovm_v1beta_proposal_proto_init() {
	if File_sge_legacy_ovm_v1beta_proposal_proto != nil {
		return
	}
	file_sge_legacy_ovm_v1beta_ticket_proto_init()
	file_sge_legacy_ovm_v1beta_vote_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_sge_legacy_ovm_v1beta_proposal_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sge_legacy_ovm_v1beta_proposal_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sge_legacy_ovm_v1beta_proposal_proto_goTypes,
		DependencyIndexes: file_sge_legacy_ovm_v1beta_proposal_proto_depIdxs,
		EnumInfos:         file_sge_legacy_ovm_v1beta_proposal_proto_enumTypes,
		MessageInfos:      file_sge_legacy_ovm_v1beta_proposal_proto_msgTypes,
	}.Build()
	File_sge_legacy_ovm_v1beta_proposal_proto = out.File
	file_sge_legacy_ovm_v1beta_proposal_proto_rawDesc = nil
	file_sge_legacy_ovm_v1beta_proposal_proto_goTypes = nil
	file_sge_legacy_ovm_v1beta_proposal_proto_depIdxs = nil
}
